...
class Network(minitorch.Module):
    ...
    def __init__(self):
        ...
        self.fc_1 = Linear(392, 64)
        self.fc_2 = Linear(64, C)
    ...
    def forward(self, x):
        ...
        fc_1 = self.fc_1(pool.view(BATCH, 392)).relu()
        fc_1 = minitorch.dropout(fc_1, 0.25, not self.training)
        fc_2 = self.fc_2(fc_1)

        return minitorch.logsoftmax(fc_2, 1)
