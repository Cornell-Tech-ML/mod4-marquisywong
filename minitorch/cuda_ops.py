...
def tensor_map(
    ...
    def _map(
        ...
        if i < out_size:
            ...
            #flattened input tensor storage
...
def tensor_zip(
    ...
    def _zip(
        ...
        if i < out_size:
            ...
            #multi-dim index for input tensor 'b'
...
def tensor_reduce(
    ...
    def _reduce(
        ...
        if out_pos < out_size:
            ...
            #use thread pos to adjust index
            ...
            #use first thread in block to write reduced result to output
            if pos == 0:
                out[out_pos] = cache[0]
